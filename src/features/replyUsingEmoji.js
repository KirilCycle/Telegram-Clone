...
// export async function replyEmoji(options) {
//     //  // set awdawd waa a a a a a a a a a
//     // // Set the "capital" field of the city 'DC'
//     // await updateDoc(washingtonRef, {
//     //   capital: true
...
//     const {em,  chatId, userId,selectedMsgData} = options

//       console.log(selectedMsgData, 'OPS');
...
//       .doc(chatId)
//       .collection("messages")
//       .doc(selectedMsgData.id);

//     if (selectedMsgData.emj) {
//       // await updateDoc(msgRef, {
//       //   [linkToSendedEm]: arrayUnion(user)
//       // });
...
//         await updateDoc(msgRef, {
//           [linkToSendedEm]: arrayUnion(userId),
//         });
//       }

//       const emojis = selectedMsgData?.emj;
...
//         await updateDoc(msgRef, {
//           [linkToSendedEm]: arrayRemove(userId),
//         });
//       }
...
//           console.log(source[i][0], 'srch');

//             if (source[i][1][j] === userId) {
//               //case user already used emoji
//               founded = emoji;
//               last = source[i][1].length === 1;
